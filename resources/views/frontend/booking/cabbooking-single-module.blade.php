    ...
    <div class="container-fluid p-64 py-64">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 col-lg-7 col-xl-8 d-none d-md-block">
                <div class="cab-service-image text-center">
                    <img src="{{ asset('images/CabBANNER.jpg') }}" class="img-fluid cab-hero-img" alt="{{ __('Cab Service') }}" style="max-height: 400px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                </div>
            </div>
        </div>
    </div>
