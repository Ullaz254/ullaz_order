        ...
        <div class="row d-flex align-items-center">
                <div class="col-md-4  col-lg-6 d-flex align-items-center">
                    ...
                    @if( (isset(Session::get('preferences')->is_hyperlocal)) && (Session::get('preferences')->is_hyperlocal == 1) )
                        <div class="location-bar d-flex align-items-center justify-content-start" href="#edit-address" data-toggle="modal">
                ...
                <div class="col-md-8 col-lg-6 text-right d-none d-sm-block">
        ...
        <div class="mobile-menu main-menu position-fixed d-block d-sm-none">
            <div class="menu-right_">
                <ul class="header-dropdown icon-nav d-flex justify-content-around">
                    ...
                    <li class="onhover-dropdown_al mobile-account  d-inline d-sm-none"> <i class="fa fa-user" aria-hidden="true"></i>
                        {{__('My Account')}}
                        <ul class="onhover-show-div">
                            @if(Auth::user())
                                @if(Auth::user()->is_superadmin == 1 || Auth::user()->is_admin == 1)
