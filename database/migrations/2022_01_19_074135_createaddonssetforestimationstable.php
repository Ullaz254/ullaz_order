...
{ 
    ...
    public function up()
    {   
        if (!Schema::hasTable('estimate_addon_sets')) {
        ...
        if (!Schema::hasTable('estimate_addon_set_translations')) {
        ...
        if (!Schema::hasTable('estimate_addon_options')) {
        ...
        if (!Schema::hasTable('estimate_addon_option_translations')) {
        ...
        if (!Schema::hasTable('estimate_product_addons')) {
