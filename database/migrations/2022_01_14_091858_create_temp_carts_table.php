...
class CreateTempCartsTable extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('temp_cart_products')) {
        ...
        if (!Schema::hasTable('temp_cart_addons')) {
        ...
        if (!Schema::hasTable('temp_cart_coupons')) {
        ...
        if (!Schema::hasTable('temp_cart_vendor_delivery_fee')) {
