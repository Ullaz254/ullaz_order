...
$(document).ready(async function () {
        ...
        if (!latitude || !longitude) {
            latitude =
                typeof defaultLatitude !== "undefined" && defaultLatitude
                    ...
                    : "30.7333";
            longitude =
                typeof defaultLongitude !== "undefined" && defaultLongitude
                    ? defaultLongitude
                    : "76.7794";
        }
    ...
    if (
        ...
        ($.cookie("show_subscription_plan") == undefined ||
            $.cookie("show_subscription_plan") == 0)
    ) {
    ...
    if ($(".vendor_mods .nav-link").hasClass("active")) {
        var tabs = $(".vendor_mods .nav-link.active")
            .parent(".navigation-tab-item")
            .prevAll().length;
    ...
    async function setSession(type = "delivery") {
        var cartData =
            OrderStorage.getStorage("cartData") != ""
                ? JSON.parse(OrderStorage.getStorage("cartData"))
                : [];
        var cartProductCount = OrderStorage.getStorage("cartProductCount");
        if (cartProductCount > 0) {
            $("#remove_cart_modal").modal("show");
            $("#remove_cart_modal #remove_cart_button").attr(
                "data-cart_id",
                cartData.id
            );
    ...
    async function getHomePage(latitude, longitude, vtype = "") {
        ...
        $(".homepage-address span")
            .text(selected_address)
            .attr({
                title: selected_address,
                "data-original-title": selected_address,
            });
            ...
            success: function (response) {
                if (response.status == "Success") {
                    ...
                    if (response.data.banners != "") {
                        let desktop_banners_template = _.template(
                            $("#desktop_banners_template").html()
                        );
                        $(".al_desktop_banner").append(
                            desktop_banners_template({
                    ...
                    if (response.data.mobile_banners != "") {
                        ...
                        let mobile_banners_template = _.template(
                            $("#mobile_banners_template").html()
                        );
                        $(".al_mobile_banner").append(
                            mobile_banners_template({
                                banners: response.data.mobile_banners,
                            })
                        );
                    }
        ...
        $.ajax({
            ...
            success: async function (response) {
                if (response.status == "Success") {
                    var path = window.location.pathname;
                    if (path == "/") {
                        let products_template = _.template(
                        ...
                        switch (item) {
                            case "trending_vendors":
                                if (response.data.trending_vendors.length > 0) {
                                    ...
                                    let trending_vendors_template = _.template(
                                        $("#trending_vendors_template").html()
                                    );
                                    $(".render_trending_vendors").append(
                                        trending_vendors_template({
                                            trending_vendors:
                                                response.data.trending_vendors,
                                            type: vendor_language,
                                        })
                                    );
                                    $(
                                        ".suppliers-slider-trending_vendors"
                                    ...
                                    $(".render_full_trending_vendors").addClass(
                                        "d-none"
                                    );
                                }
                                break;
                            case "vendors":
                                $(".render_vendors").html("");
                                if (
                                    $(".suppliers-slider-vendors").hasClass(
                                        "slick-initialized"
                                    )
                                ) {
                                ...
                                let vendors_template = _.template(
                                    $("#vendors_template").html()
                                );
                                $(".render_vendors").append(
                                    vendors_template({
                                ...
                                if (response.data.vendors.length > 0) {
                                    $(".render_full_vendors").removeClass(
                                        "d-none"
                                    );
                                } else {
                                    $(".render_full_vendors").addClass(
                                        "d-none"
                                    );
                                }
                                break;
                            case "featured_products":
                                if (
                                    $(".product-4-featured_products").hasClass(
                                        "slick-initialized"
                                    )
                                ) {
                                ...
                                $(".render_featured_products").append(
                                    products_template({
                                        products:
                                            response.data.feature_products,
                                        type: featured_product_language,
                                    })
                                );
                                $(".product-4-featured_products").slick({
                                    dots: false,
                            ...
                            case "new_products":
                                if (response.data.new_products.length > 0) {
                                    if (
                                        $(".product-4-new_products").hasClass(
                                            "slick-initialized"
                                        )
                                    ) {
                                    ...
                                    $(".render_new_products").append(
                                        products_template({
                                            products:
                                                response.data.new_products,
                                            type: new_product_language,
                                        })
                                    );
                                    $(".product-4-new_products").slick({
                                        dots: false,
                                    ...
                                    $(".render_full_new_products").removeClass(
                                        "d-none"
                                    );
                                } else {
                                    $(".render_full_new_products").addClass(
                                        "d-none"
                                    );
                                }
                            ...
                            case "on_sale":
                                if (response.data.on_sale_products.length > 0) {
                                    ...
                                    $(".render_on_sale").append(
                                        products_template({
                                            products:
                                                response.data.on_sale_products,
                                            type: on_sale_product_language,
                                        })
                                    );
                                    $(".product-4-on_sale").slick({
                                        dots: false,
                                    ...
                                    $(".render_full_on_sale").removeClass(
                                        "d-none"
                                    );
                                } else {
                                    $(".render_full_on_sale").addClass(
                                        "d-none"
                                    );
                                }
                                break;
                            case "best_sellers":
                                if (response.data.new_products.length > 0) {
                                    if (
                                        $(".product-4-best_sellers").hasClass(
                                            "slick-initialized"
                                        )
                                    ) {
                                        $("#best_sellers").html("");
                                    ...
                                    $(".render_best_sellers").append(
                                        products_template({
                                            products:
                                                response.data.new_products,
                                            type: best_seller_product_language,
                                        })
                                    );
                                    $(".render_full_best_sellers").removeClass(
                                        "d-none"
                                    );
                                } else {
                                    $(".render_full_best_sellers").addClass(
                                        "d-none"
                                    );
                                }
                                break;
                            case "brands":
                                if (response.data.brands.length > 0) {
                                    ...
                                    let banner_template = _.template(
                                        $("#banner_template").html()
                                    );
                                    $(".render_brands").append(
                                        banner_template({
                                    ...
                                    $(".render_full_brands").removeClass(
                                        "d-none"
                                    );
                                } else {
                            ...
                            case "recent_orders":
                                if (response.data.active_orders.length > 0) {
                                    ...
                                    let recent_orders_template = _.template(
                                        $("#recent_orders_template").html()
                                    );
                                    $(".render_recent_orders").append(
                                        recent_orders_template({
                                    ...
                                    $(".render_full_recent_orders").removeClass(
                                        "d-none"
                                    );
                                } else {
                                    $(".render_full_recent_orders").addClass(
                                        "d-none"
                                    );
                                }
                                break;
                            case "cities":
                                if (response.data.cities.length > 0) {
                                    if (
                                        $(".suppliers-slider-cities").hasClass(
                                            "slick-initialized"
                                        )
                                    ) {
                                    ...
                                    let city_template = _.template(
                                        $("#cities_template").html()
                                    );
                                    $(".render_cities").append(
                                        city_template({
                                    ...
                                    $(".render_full_cities").removeClass(
                                        "d-none"
                                    );
                                } else {
            ...
            success: function (response) {
                if (response.status == "success") {
                    ...
                    if ($(".nav-tabs.vendor_mods .nav-link").length > 0) {
                        vendor_mod = $(".nav-tabs.vendor_mods").attr(
                            "data-mod"
                        );
                    }
                    OrderStorage.setStorageSingle("cartProductCount", 0);
                    if (
                        ondemand_pricing_mode != "" &&
                        ondemand_pricing_mode != undefined
                    ) {
            ...
            await $.ajax({
                ...
                success: async function (response) {
                    ...
                    if (response.status == "Success") {
                        ...
                        if (
                            !isLocalhost &&
                            data.navCategories.length > 0 &&
                            vendor_type == "pick_drop"
                        ) {
                            var category = data.navCategories[0].slug;
                            window.location.href = category_page_url.replace(
                                ":id",
                                category
                            );
                            redirect = 1;
                        ...
                        let nav_categories_template = _.template(
                            $("#nav_categories_template").html()
                        );
                        await $("#main-menu").html(
                            nav_categories_template({
                                nav_categories: response.data.navCategories,
                            })
                        );
                        await $("#main-menu").smartmenus({
...
$(document).on(
    "click",
    ".select_on_demand_pricing_by_user",
    async function (e) {
        e.preventDefault();
        var type = document.querySelector(
            'input[name="onDemandpricingselection"]:checked'
        ).value;
...
function initializeNewCabHome(random_id, rel) {
    ...
    google.maps.event.addListener(autocomplete, "place_changed", function () {
        ...
        document.getElementById(random_id + "_latitude_home").value =
            place.geometry.location.lat();
        document.getElementById(random_id + "_longitude_home").value =
